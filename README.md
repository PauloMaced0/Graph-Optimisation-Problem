...
A ratio of **1.00** signifies that the greedy heuristic has achieved an optimal solution, perfectly matching the exhaustive search. Ratios exceeding **1.00** (highlighted in red) indicate instances where the greedy heuristic yields a suboptimal solution, resulting in a higher total weight compared to the exhaustive search. In this case, the greedy heuristic achieved a precision of **88.5%**.

| Number of Nodes | Greedy Weight | Exhaustive Weight | Ratio (Greedy/Exhaustive) |
|-----------------|---------------|-------------------|----------------------------|
| 4               | 11.78         | 11.78             | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 5               | 17.73         | 13.70             | 1.29 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 6               | 10.77         | 10.77             | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 7               | 4.05          | 4.05              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 8               | 4.05          | 2.51              | 1.61 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 9               | 2.34          | 2.34              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 10              | 6.52          | 5.24              | 1.25 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 11              | 1.06          | 1.06              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 12              | 6.91          | 5.24              | 1.32 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 13              | 6.08          | 6.08              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 14              | 5.54          | 5.54              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 15              | 4.99          | 4.99              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 16              | 4.99          | 4.99              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 17              | 4.99          | 4.99              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 18              | 8.59          | 5.27              | 1.63 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 19              | 5.27          | 5.27              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 20              | 5.27          | 5.27              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 21              | 6.91          | 6.91              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 22              | 7.19          | 7.19              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 23              | 10.78         | 7.19              | 1.50 ![Red](https://via.placeholder.com/15/FF0000?text=+) |

**Note:** Ratios greater than 1 (red color) indicate that the greedy algorithm's weight exceeds that of the exhaustive search.

#### Randomized Search

Table \ref{tab:random_exhaustive_comparison} presents a comparison between randomized search and exhaustive search algorithms across various node counts within a fixed density graph (0.75). The **Ratio (Random/Exhaustive)** column serves as a primary indicator of the randomized algorithm's precision relative to the optimal solutions obtained from exhaustive search.
...
|-----------------|---------------|-------------------|---------------------------|
| 4               | 16.27         | 11.78             | 1.38 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 5               | 13.70         | 13.70             | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 6               | 21.05         | 10.77             | 1.95 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 7               | 4.05          | 4.05              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 8               | 2.51          | 2.51              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 9               | 5.46          | 2.34              | 2.33 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 10              | 10.58         | 5.24              | 2.02 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 11              | 1.06          | 1.06              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 12              | 5.24          | 5.24              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 13              | 17.50         | 6.08              | 2.88 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 14              | 11.54         | 5.54              | 2.08 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 15              | 5.85          | 4.99              | 1.17 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 16              | 4.99          | 4.99              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 17              | 5.54          | 4.99              | 1.11 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 18              | 5.27          | 5.27              | 1.00 ![ForestGreen](https://via.placeholder.com/15/F0FFF0?text=+) |
| 19              | 16.78         | 5.27              | 3.18 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 20              | 12.10         | 5.27              | 2.29 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 21              | 9.41          | 6.91              | 1.36 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
| 22              | 7.73          | 7.19              | 1.08 ![Red](https://via.placeholder.com/15/FF0000?text=+) |
...
Table \ref{tab:algorithm_comparison} summarizes the performance of the three algorithms across different graph instances, highlighting key metrics such as the number of vertices and edges, the best weight achieved, and execution time.
